...
const Remodelacion = () => {
  ...
  const remodelacion = {
    ...
    carouselImgsSrcs: [
      "/static/services/remodelacion/tec13.webp",
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/remodelacion/tec14.webp",
        orientation: "right",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/remodelacion/tec35.webp",
        orientation: "left",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/remodelacion/tec16.webp",
        orientation: "right",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/remodelacion/tec36.webp",
        orientation: "left",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/remodelacion/tec18.webp",
        orientation: "right",
      },
      {
