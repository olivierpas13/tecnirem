...
const Adecuacion = () => {
  const adecuacion = {
    ...
    carouselImgsSrcs: [
      "/static/services/adecuacion/tec32.jpg",
    ...
    sections: [
      {
        ...
        description:
          ...
          imageUrl: "/static/services/adecuacion/tec33.jpg",
          orientation: "left",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/adecuacion/tec9.jpg",
          orientation: "right",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/adecuacion/tec10.jpg",
          orientation: "left",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/adecuacion/tec11.jpg",
          orientation: "right",
      },
      {
        ...
        description:
          ...
          imageUrl: "/static/services/adecuacion/tec12.jpg",
          orientation: "left",
      },
    ],
